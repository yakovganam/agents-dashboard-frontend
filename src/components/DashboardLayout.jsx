...
export const Sidebar = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 glass-panel border-r border-white/5 flex flex-col z-50">
...
export const Header = () => {
  return (
    <header className="fixed top-0 right-0 left-64 h-20 glass-panel border-b border-white/5 flex items-center justify-between px-8 z-40">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            ...
            <p className="text-xs text-anthracite-400">System Admin</p>
          </div>
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-anthracite-800 to-anthracite-700 border border-white/10 flex items-center justify-center overflow-hidden">
            <img 
